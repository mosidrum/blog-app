...
RSpec.describe Comment, type: :model do
  describe 'Comment model' do
    ...
    post = Post.new(title: 'title', text: 'I dont have a title so I choose any title!', author: user2, likes_counter: 3,
                    comments_counter: 7)
    comment = Comment.create(post:, user: user1, text: 'serina is a good girl')
